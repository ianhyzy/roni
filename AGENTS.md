...
without their tool schema that skip validating their own input, and
typecheck config widenings that declare Node globals project-wide and
thereby hide Node-only APIs used in Convex's default V8 runtime). Skim the
